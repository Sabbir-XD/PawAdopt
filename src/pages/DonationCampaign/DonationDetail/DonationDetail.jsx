...
import { FaHandHoldingHeart, FaMapMarkerAlt, FaRegClock, FaArrowLeft } from "react-icons/fa";
...
const DonationDetails = () => {
  ...
  if (isLoading) return <CardSkeleton count={1} className="max-w-5xl mx-auto" />;
    ...
    return (
      <div className="max-w-5xl mx-auto text-center py-20">
        <div className="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 p-6 rounded-lg inline-block max-w-md">
          ...
          <Link to="/donation-campaigns" className="mt-4 inline-flex items-center text-teal-600 dark:text-teal-400 hover:underline">
            ← Back to campaigns
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 sm:px-6 lg:px-8 mt-10">

      {/* 🔙 Back Button */}
      <div className="mb-6">
        <Link to="/donation-campaigns" className="inline-flex items-center text-sm font-medium text-teal-600 dark:text-teal-400 hover:underline">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="relative group">
          <img
            ...
            className="w-full max-h-[500px] object-cover rounded-xl shadow-md group-hover:shadow-teal-200/50 dark:group-hover:shadow-teal-800/30 transition-shadow"
            onError={(e) => (e.target.src = "/placeholder-pet.jpg")}
          />
          <div className="absolute top-4 left-4 bg-white/90 dark:bg-gray-900/90 px-3 py-1 rounded-full shadow-sm flex items-center backdrop-blur-sm">
            {!isActive ? (
        ...
        <div className="space-y-6">
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-teal-50">
          ...
          <div className="space-y-2">
            ...
            <Progress value={progressPercentage} className="h-3 bg-gray-200 dark:bg-gray-700" indicatorClassName="bg-teal-500 dark:bg-teal-600" />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <p className={`font-medium ${isExpired ? 'text-red-500 dark:text-red-400' : 'dark:text-teal-100'}`}>
          ...
          {campaign.shortDescription && (
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-lg mb-2 dark:text-teal-100">Short Description</h3>
              <p className="text-gray-700 dark:text-gray-300">{campaign.shortDescription}</p>
            </div>
          )}

          {campaign.longDescription && (
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="font-semibold text-lg mb-2 dark:text-teal-100">Full Story</h3>
              <div
          ...
          {isActive ? (
            <Button
              ...
              className="w-full bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white py-6 text-lg shadow-md hover:shadow-teal-500/20"
            >
              <FaHandHoldingHeart className="mr-2 text-white" />
              Donate Now
            </Button>
          ) : (
            <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 text-yellow-700 dark:text-yellow-300 p-4 rounded-lg flex items-center">
      ...
      <div className="mt-16">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-teal-100 mb-6">
